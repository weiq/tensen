...
jQuery(function($) {
    ...
    // ************Owl Carousel
    $("#news_slider, #director_slider").owlCarousel({
        autoPlay: false,
        items: 3,
        pagination: false,
        stopOnHover: true,
    ...
    $("#news_slider_lqyx").owlCarousel({
     ...
     $("#news_slider2, #director_slider").owlCarousel({
        autoPlay: false,
        items: 4,
        pagination: false,
        stopOnHover: true,
     ...
     $("#news_slider, #director_slider, #course_slider1").owlCarousel({
        autoPlay: false,
        items: 4,
        pagination: false,
        stopOnHover: true,
     ...
     $("#course_slider_cooperation").owlCarousel({
         autoPlay: false,
         items: 1,
         pagination: true,
         stopOnHover: false,
     ...
     $("#course_slider_school").owlCarousel({
         autoPlay: false,
         items: 5,
         pagination: false,
         stopOnHover: true,
     ...
     $("#course_slider_service").owlCarousel({
         autoPlay: false,
         items: 5,
         pagination: false,
         stopOnHover: true,
     ...
     $("#course_slider_teach").owlCarousel({
         autoPlay: false,
         items: 3,
         pagination: false,
         stopOnHover: true,
     ...
     $("#course_slider_teach2").owlCarousel({
         autoPlay: false,
         items: 3,
         pagination: false,
         stopOnHover: true,
     ...
     $("#course_slider_teach3").owlCarousel({
         autoPlay: false,
         items: 4,
         pagination: false,
         stopOnHover: true,
     ...
     $("#vip_xc_slider_lqyx").owlCarousel({
         autoPlay: false,
         items: 10,
         pagination: false,
         stopOnHover: true,
     ...
     $("#vip_xc_slider_lqyx2").owlCarousel({
         autoPlay: false,
         items: 10,
         pagination: false,
         stopOnHover: true,
     ...
     $(".consulting-img-show").owlCarousel({
         autoPlay: true,
         items:3,
         pagination: true,
         stopOnHover: false,
     ...
     $("#director_slider, #course_slider").owlCarousel({
        autoPlay: false,
        items: 6,
        pagination: false,
        stopOnHover: true,
